    ...
    <div className="flex flex-col md:flex-row md:items-start items-center justify-between px-8  min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558fe] to-[#a9cfff] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden">
      <div className="text-white">
        ...
        <p className="max-w-130">
          We take car eof insurance,driver verification and secure payments so
          you can earn passive income,stress-free
        </p>

        <button className="px-6 py-2 bg-white hover:bg-slate-100 transition-all text-[#0558fe] rounded-lg text-sm mt-4 cursor-pointer">
          List your car
        </button>
      </div>
